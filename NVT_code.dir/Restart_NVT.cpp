...
int main(int argc, char* argv[])
{
  ...
  */
  ...
  char filec[60];
  char filev[60];
  sprintf(file, "themostat.%d", rank);
  ofstream thermfile(file);
  int save100;
  int pt;
  ...
  */
  ...
  // ScaleVelocity(NVT, cons, parms, myvel);
  ...
  */
  int start=400001;
  int Tend=cons.Tsteps+1;

  Einitial=-16063.2617343;
  a.Eavg=-16058.7271307*start;
  a.E2avg=257882722.805*start;
  a.Epavg=-19092.2867243*start;
  a.Ekavg=3068.5121642*start;
  a.Tavg=297.951534203*start;
  a.Pavg=7.54164885166*start;
  a.P2avg=250000*start;
