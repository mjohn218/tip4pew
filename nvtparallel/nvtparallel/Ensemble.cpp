...
and establish teh position of the imaginary 4th 'atom' of water*/
  ...
  /*Scale Factor*/
  parms.rhoold=parms.rhoold*parms.AVAGAD/parms.MOLWT;
  parms.BOXLOLD=pow(cons.N/parms.rhoold, (1.0/3.0));
  double SCBOXL;
  SCBOXL=parms.BOXLENGTH/parms.BOXLOLD;

  if(parms.rhoold>0) cout<<" Scaling Initial config to BOXLOLD! "<<parms.BOXLOLD<<endl;
  if(parms.rhoold>0) cout<<" Old DENSITY "<<parms.rhoold*parms.MOLWT/parms.AVAGAD <<endl;
...
void printAllVelf(char *filename, Constants cons, int t, DiffSend *vel)
{
  int i;
  ofstream outFile(filename);
...
void RattleVel(Constants cons, Parameters parms, WaterSend *local_mols, DiffSend *vel, double *Mat, double *Minv)
{
  ...
  Minv[0]=1.81272052749;
  Minv[1]=0.793593076843;
  Minv[2]=-0.651578401084;
  Minv[3]=0.793593076843;
  Minv[4]=1.81272052749;
  Minv[5]=-0.651578401084;
  Minv[6]=-0.651578401084;
  Minv[7]=-0.651578401084;
  Minv[8]=0.545536696905;
