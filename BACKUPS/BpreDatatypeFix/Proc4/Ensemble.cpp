...
void Ensemble::calcEForce(Ensemble &NNN, Constants cons, Parameters parms, WaterSend *mols, WaterSend *local_mols)
{
  ...
  */
  ...
  NNN.Primder(cons, parms, mols, local_mols);
		  ...
		  for(n=1;n<cons.NSITE;n++)
		    {
		      ...
		      Term1=Q1*Term;
		      Temp=parms.CoeffPi*cons.ALPHA*exp(-cons.Alpha2*RijSQUARED)+Term;
		      Term1A=Q1*Temp/RijSQUARED;
		      FXnew=Term1A*RXnew;
		      FYnew=Term1A*RYnew;
		      FZnew=Term1A*RZnew;
		      SumQQ+=Term1;
...
void Ensemble::Primder(Constants cons, Parameters parms, WaterSend *mols, WaterSend *local_mols )
{
