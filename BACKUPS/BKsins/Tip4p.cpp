...
//  MPI::COMM_WORLD.Barrier();
  ...
  if(cons.rank==0)
    {
      Efinish[0]=Efinish[0]/(cons.nproc*1.0);
      Efinish[1]=Efinish[1]/(cons.nproc*1.0);
      Efinish[2]=Efinish[2]/(cons.nproc*1.0);
      ...
      cout <<" EPOT: "<<NNN.EPOT <<" EKIN " <<NNN.EKIN <<" ELRCint "<<NNN.ELRCint<<" PLRCint "<< NNN.PLRCint <<endl;
