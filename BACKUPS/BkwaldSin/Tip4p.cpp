...
void NVEintegrateMotion(Ensemble &NVE, Constants cons, Parameters parms, WaterSend *mols, WaterSend *local_mols, MPI::Datatype Watertype, int t, double *Kreal, double *Kimag, double *SKreal, double *SKimag, Kindex *kxyz, DiffSend *myopos, DiffSend *vel, WaterSend *force, Center *com);

void mKWALD(Ensemble &NNN, Constants cons, Parameters parms, WaterSend *mols, WaterSend *local_mols, double *Kreal, double *Kimag, double *SKreal, double *SKimag, Kindex *kxyz, WaterSend *force, Center *com);

void mcalcEForce(Ensemble &NNN, Constants cons, Parameters parms, WaterSend *mols, WaterSend *local_mols, double *Kreal, double *Kimag, double *SKreal, double *SKimag, Kindex *kxyz, WaterSend *force, Center *com);
...
int main(int argc, char* argv[])
{
  ...
  */
  ...
  mcalcEForce(NVE, cons, parms, mols, local_mols, Kreal, Kimag, SKreal, SKimag, kxyz, force, com);
  ...
  */
  ...
  for(t=1;t<Teqp1;t++)
	...
	inside NVEintegrateMotion is an AllGather MPI call.
      ...
      NVEintegrateMotion(NVE,cons,parms, mols, local_mols, Watertype, t, Kreal,  Kimag, SKreal, SKimag, kxyz, myopos, myvel, force, com);
...
void mcalcEForce(Ensemble &NNN, Constants cons, Parameters parms, WaterSend *mols, WaterSend *local_mols, double *Kreal, double *Kimag, double *SKreal, double *SKimag, Kindex *kxyz, WaterSend *force, Center *com)
{
  ...
  RWALD(cons, parms, mols, local_mols, force, com, NNN);
  
  //find n bonded energy and derivatives in reciprocal space
  
  mKWALD(NNN, cons, parms, mols, local_mols, Kreal, Kimag, SKreal, SKimag, kxyz, force, com);
